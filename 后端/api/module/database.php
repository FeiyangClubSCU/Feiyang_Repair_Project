...
function db_exec($db_exec_comm){
  ...
  include $db_exec_path.'/config/db.php';
  $db_exec_conn = mysqli_connect( 
  $db_conf_addr,$db_conf_user,$db_conf_pswd,$db_conf_name);
...
function db_putc($db_putc_form,  //数据表名
  ...
  include $db_putc_path.'/config/db.php';
          $db_putc_temp="UPDATE "
                       .$db_putc_form
                       ." SET "
                       .$db_putc_toch
...
function db_alls($db_alls_from){
    ...
    include $db_alls_path.'/config/db.php';
