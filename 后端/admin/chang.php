        ...
        if($_SERVER['REQUEST_METHOD']== 'POST'){
            ...
            if($response->result){
                ...
                elseif($chang_temp==""){
                    ...
                    $chang_temp=db_putc("fy_admin","user",$_SESSION["users"],"pass","\"".md5($posts["pass"])."\"");
                    echo $chang_temp;
                    //exit();
                ...
                <div class="form-outer text-center d-flex align-items-center">
                    <div class="form-inner">
                        <div class="logo text-uppercase">
                            <span>飞扬维修</span>
                            <strong class="text-primary">- 修改密码</strong></div>
                        <br />
                        <div align="center">
                            <!--
                        ...
                        <p>你正在修改飞扬维修报修系统管理员密码</p>
                        <form id="loginform" method="post" action="chang.php" class="text-left form-validate">
                            <div class="form-group-material">
                                <input  id="login-username" type="text"     name="user" required data-msg="请输入账号" class="input-material" value="<?php echo $_SESSION["users"]; ?>" readonly="">
                                <label for="login-username" class="label-material"></label></div>
                            <div class="form-group-material">
                                <input  id="login-password" type="password" name="pass" required data-msg="请输入密码" class="input-material">
                                <label for="login-password" class="label-material">管理密码</label></div>
                            <div class="form-group-material">
                                <input  id="login-password" type="password" name="conf" required data-msg="请输入密码" class="input-material">
                                <label for="login-password" class="label-material">再次确认</label></div>
                          <input id="login-vertoken" name="loginvertoken" type="hidden" required data-msg="请完成验证" class="input-material" />
                            <div class="form-group text-center">
                                ...
                                <br />
                                <br />
                                <input  style="display:inline;" type="submit" class="btn btn-primary"                                  value="确认修改" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <button style="display:inline;" type="button" class="btn btn-warning"  onclick="javascript:history.back(-1);">放弃修改</button>
                            </div>
                        </form>
